...
namespace BL.Maintenance
{
    ...
    {
        public static ML.Result GetScnInfo(string numScn, string codPto, string mode)
        {
            ML.Result result = new ML.Result();
            try
            {
                ML.Result resultGetOracleCode = GetOracleCode(codPto, mode);
                ...
                using (OdbcConnection connection = new OdbcConnection(DL.Connection.GetConnectionStringGen(mode)))
                {
                    ...
                    scnInfo.ApiRequestWMS = GetOracleWMSInfo(scnInfo.OrdRel, facility, mode);
        ...
        private static ML.Maintenance.ApiRequestWMS GetOracleWMSInfo(string orderNumber, string facility, string mode)
        {
